	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			<div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
				...
				<div class="navi">
					<ul>
						<li><a href="/admin/home"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Home</span></a></li>
						<li><a href="/admin/talent"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Talent</span></a></li>
						<li><a href="/admin/recruiter"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Recruiter</span></a></li>
						<li><a href="/admin/subscribers"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">subscribers</span></a></li>
