    ...
    <div style="padding: 83px 25%;" class="bg-light">
        <div class="container-for-gmail-android" width="50%" style="padding: 5%; background-color: #f2f2ee; box-shadow: 0px 1px 14px #ccc;">
            ...
            <div style="padding:20px 0px 0px 20px">
                <h2>Welcome <span class="text-muted" style="color: #88e5b3;"> Ogundipe Abisola,</span></h2>
                <div style="padding-left: 50px; font-size: larger;">
                    <p>You registered with <span style="color: #88e5b3;"></span> Laryliv@gmail.com.</p>
                    <p>click <a href="#" style="color: green;">here</a> to join the Community</p>
                </div>
